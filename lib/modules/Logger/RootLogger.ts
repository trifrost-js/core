...
import {type TriFrostLoggerSpanAwareExporter, type TriFrostLogger, type TriFrostLoggerExporter} from './types';
...
export class TriFrostRootLogger<Env extends Record<string, any> = Record<string, any>> {
    ...
    constructor(cfg: {runtime: TriFrostRuntime; exporters: LazyInitFn<TriFrostLoggerExporter[], Env>}) {
    ...
    spawn(ctx: {traceId: string; env: Env; context?: Record<string, unknown>}): TriFrostLogger {
        try {
