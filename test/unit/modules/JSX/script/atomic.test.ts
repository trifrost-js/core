        ...
        it('Should be minified correct', () => {
            expect(ATOMIC_GLOBAL).toBe(
                [
                    ...
                    'try{return n.querySelector(scopable?":scope "+q:q);}catch{return null;}',
                    '}],',
                    /* $.queryAll */
                    '["queryAll",(n,q)=>{',
                    'if(!n?.querySelectorAll||typeof q!=="string")return [];',
                    'const scopable=n.nodeType===Node.ELEMENT_NODE&&!q.trimStart().startsWith(":scope");',
                    'try{return [...n.querySelectorAll(scopable?":scope "+q:q)];}catch{return [];}',
                    '}],',
                    /* $.storeGet */
